...
function Contact() {
  return (
    <div className='flex items-center justify-center w-full min-h-screen gap-40 py-32'>
      <div className="flex flex-col justify-between gap-6 text-white w-96">
        <div className="">
      ...
      <div className="flex flex-col gap-5">
        ...
        <div className="flex gap-3">
            <a  href="https://www.facebook.com/quantixllc">
              <svg className='w-6 h-6' xmlns="http://www.w3.org/2000/svg" fill='white' viewBox="0 0 512 512">
            ...
            <a href="https://www.linkedin.com/company/quantix-llc/">
              <svg fill='white' className='w-6 h-6' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
